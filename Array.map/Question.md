...
Notes
The map callback function takes in more than just the element! There's also a second parameter for Array.prototype.map. You are recommended to read the specification for Array.prototype.map on MDN Docs before attempting.